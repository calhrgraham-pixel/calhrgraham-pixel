...
I'm a second-year **Computer Science** student at the **Illinois Institute of Technology**, pursuing a minor in **Game Design & Experiential Media** and planning an accelerated Master's in **Artificial Intelligence**. I'm passionate about problem-solving, game development, and building innovative entertainment experiences through code.
...
**Part-Time Game Developer** · Rackico Games / Stratton Studios · Los Angeles, CA
*June 2024 – Present*
- Collaborated with design leads on an in-development computer/mobile RPG
- Provided in-depth notes and reports on newly deployed game systems
- Implemented console controller input to port the game to Xbox, PlayStation & Nintendo Switch
- Built in-game skills for combat (attack, defend, etc.) using the Unity editor
...
![GameMaker](https://img.shields.io/badge/GameMaker-71b417?style=for-the-badge&logo=gamemaker&logoColor=white)
...
![Google Suite](https://img.shields.io/badge/Google_Suite-34a853?style=for-the-badge&logo=google&logoColor=white)
